...
public class HeightRewardShow : MonoBehaviour
{
    ...
    CheckPoints chkpnt;
    public Text Bonus;
    HeightLapTime laptime;
    [HideInInspector] public bool BrewardCheck = false;
    ...
    public static HeightRewardShow Instance;
    private void Awake()
    {
        Instance = this;
    }
    private void Start()
    {
        ...
        check = true;
        laptime = FindObjectOfType<HeightLapTime>();
