...
public class MarsFinishLines : MonoBehaviour
{
    ...
    void Start()
    {
        FinCount = GameManager.Instance.MarsLevelNo;
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Vehicle" && Ghost_Recorder.levelFinished == false)
        {
            ...
            if (PlayerPrefs.GetInt("FinishCount") >= 2)
            {
                ...
                //ADS_Manager.Instance.OnClickInterstitial();
    ...
    IEnumerator ExampleCoroutine()
    {
        ...
        FirebaseAnalytics.LogEvent("Level_Finish_Mars", "Level_Finish_Num", FinCount);
        yield return new WaitForSeconds(0.01f);
        AudioListener.pause = true;
        MarsUIManager.Instance.ShowCompletePanel();
    }
