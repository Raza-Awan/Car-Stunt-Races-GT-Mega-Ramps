...
public class FrontFlipCheck : MonoBehaviour
{
    public int levelNo;
    public int objectiveNo;

    public int numberOfFlipsToCheck;
    ...
    void Update()
    {
        ...
        if (numberOfFlipsToCheck == AirCarControl.INSTANCE.frontFlipCount && objectiveComplete == false)
        {
