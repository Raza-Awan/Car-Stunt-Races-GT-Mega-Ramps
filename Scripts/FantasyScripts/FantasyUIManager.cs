...
public class FantasyUIManager : MonoBehaviour
{
    public static FantasyUIManager Instance;
    ...
    public void ShowCompletePanel()
    {
        ...
        int levelNo = PlayerPrefs.GetInt("NextLevelFantasy");
        ...
        if (LeaderBoard.INSTANCE.playerFinishedFirst == true)
        {
            ...
            if (levelNo == GameManager.Instance.FantasyLevelNo)
            {
                levelNo++;
                PlayerPrefs.SetInt("NextLevelFantasy", levelNo);
                FantasyRewardShow.Instance.LevelFinishReward();
                //LevelProgressHandler.INSTANCE.SetProgressValueOnFirstFinish();
                FantasyRewardShow.Instance.GiveExpPoints_FirstTime();
            }
            else
            {
                FantasyRewardShow.Instance.FinishedLevelReplayReward();
                //LevelProgressHandler.INSTANCE.SetProgressValueOnReplay();
                FantasyRewardShow.Instance.GiveExpPoints_OnReplay();
            }
        ...
        else
        {
            ...
            FantasyRewardShow.Instance.LevelFailedReward();
        }
    }
    ...
    public void OnClickNextButton()
    {
        ...
        GameManager.Instance.FantasyLevelNo += 1;
        Invoke("FantasyScene", 5f);
    }
